<form wire:submit.prevent="register" class="max-w-md w-full mx-auto backdrop-blur-2xl bg-white dark:bg-gray-800 p-8 rounded-xl shadow-xl border dark:border-gray-700">
  <div class="space-y-6">
    ...
    <div class="text-center text-sm text-gray-600 dark:text-gray-400 mt-4">
      حساب کاربری دارید؟ <a href="{{ route('login') }}" class="text-blue-600 hover:underline dark:text-blue-400">وارد شوید</a>
    </div>
  </div>
</form>
