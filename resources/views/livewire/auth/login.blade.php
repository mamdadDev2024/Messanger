<form wire:submit.prevent="login" class="max-w-md w-full mx-auto backdrop-blur-2xl bg-white dark:bg-gray-800 p-8 rounded-xl shadow-xl border dark:border-gray-700">
  <div class="space-y-6">
    <h2 class="text-2xl font-bold text-center text-gray-800 dark:text-gray-100 mb-6">ورود به حساب کاربری</h2>
    ...
    <div>
      ...
      />
      @error('email')
        <div class="flex items-center gap-2 mt-1 text-red-600 dark:text-red-400 text-sm">
    ...
    <div class="text-center text-sm text-gray-600 dark:text-gray-400 mt-4">
      حساب کاربری ندارید؟ <a href="{{ route('register') }}" class="text-blue-600 hover:underline dark:text-blue-400">ثبت‌نام کنید</a>
    </div>
  </div>
</form>
